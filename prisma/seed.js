...
async function main() {
    ...
    create: {
      ...
      content: {
        ...
        content: [
          ...
          { type: 'paragraph', content: [{ type: 'text', text: 'Welcome to BaseDocs! This is your engineering documentation hub.' }] },
          { type: 'heading', attrs: { level: 2 }, content: [{ type: 'text', text: 'Setup' }] },
          { type: 'paragraph', content: [{ type: 'text', text: 'Follow these steps to set up your development environment.' }] },
        ],
      },
    ...
    create: {
      ...
      content: {
        ...
        content: [
          ...
          { type: 'paragraph', content: [{ type: 'text', text: 'This document describes the high-level architecture of our system.' }] },
        ],
      },
      spaceId: engineeringSpace.id,
  ...
  await prisma.page.upsert({
    ...
    create: {
      ...
      content: {
        type: 'doc',
        content: [
          { type: 'heading', attrs: { level: 1 }, content: [{ type: 'text', text: 'Product Roadmap' }] },
          { type: 'paragraph', content: [{ type: 'text', text: 'Our product roadmap for the upcoming quarters.' }] },
        ],
      },
  ...
  await prisma.activity.create({
    data: {
      action: 'Created space "Engineering"',
      userId: admin.id,
    },
  })
