...
async function main() {
    ...
    create: {
      ...
      content: {
        ...
        content: [
          ...
          { type: 'paragraph', content: [{ type: 'text', text: 'Welcome to BaseDocs!' }] },
        ],
      },
    ...
    create: {
      ...
      content: {
        ...
        content: [
          ...
          { type: 'paragraph', content: [{ type: 'text', text: 'High-level system architecture.' }] },
        ],
      },
      spaceId: engineeringSpace.id,
    ...
    create: {
      ...
      content: {
        ...
        content: [
          ...
          { type: 'paragraph', content: [{ type: 'text', text: 'Our product roadmap for upcoming quarters.' }] },
        ],
      },
  ...
  await prisma.activity.createMany({
    data: [
      { action: 'Created space "Engineering"', userId: admin.id },
      { action: 'Created space "Product"', userId: admin.id },
    ],
    skipDuplicates: true,
  })
